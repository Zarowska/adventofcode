public class Day2 {
    public static void main(String[] args) {
        ...
        int quantityValidPasswordsPartTwo = 0;
        ...
        for (int i = 0; i < myList.countLines(); i++) {
            if (PasswordPolicyPartTwo.checkPasswordPolicy(myList.getLine(i))) {
                quantityValidPasswordsPartTwo++;
            };
        }

        System.out.println("The second part of the task: Quantity valid passwords is equal to " + quantityValidPasswordsPartTwo);
    }
}